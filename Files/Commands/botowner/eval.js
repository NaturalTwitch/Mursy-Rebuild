module.exports = {
    name: 'evaluate',
    aliases: ['eval'],
    description: `Evaluate/Test Code to ensure its correct - Only Accessible to Mursy's Dev Teams`,
    async execute(client, message, cmd, args, Discord) {
        if (message.content.includes('client.token')) return message.channel.send(` \`\`\`Cannot Share the Bot's Token\`\`\` `)
        ...
        if (
            ...
            message.author.id === '645703827655360578'
        ) {
